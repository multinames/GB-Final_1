...
// Метод для подсчета строк в массиве удовлетворяющих условию
{
...
// Метод добавления строк, содержащих менее трех символов, в новый массив
{
for (int i = 0; i < arr1.Count(); i++)    
        if (arr1[i].Length <= 3) 
        {
...
// Создание нового массива необходимого размера после подсчета удовлетворяющих условию строк в исходном массиве
